...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            dsh::desktop_bridge_plugins,
            dsh::desktop_bridge_install,
            dsh::desktop_bridge_remove,
            dsh::desktop_bridge_set_enabled,
            dsh::desktop_bridge_config,
            dsh::desktop_bridge_config_edit,
