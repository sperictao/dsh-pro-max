...
const claudeSonnet = { id: "claude-sonnet-4", name: "Claude Sonnet 4", context: 200000, maxTokens: 32000, input: ["text", "image"], reasoning: true, reasoningLevels: ["low", "medium", "high"], capabilities: ["text", "vision", "reasoning"] };
