...
// Scope: inspect untouched edit state, edit common fields, save, verify persistence.
...
const spero = {
  route: "spero-ai", displayName: "Spero AI", baseURL: "https://proxy.example.com/v1",
  api: "openai-responses", apiKeyEnv: "SPERO_AI_API_KEY",
...
const modelConfig = { defaultProvider: "spero-ai", defaultModel: "glm-5.2", defaultReasoningEffort: "max", providers: [spero, deepseek] };
const modelCatalog = {
  fetchedAt: Math.floor(Date.now() / 1000), providerCount: 2,
  entries: [
