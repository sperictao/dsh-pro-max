...
const catalogEntries = [
  ...
  { id: "deepseek-v4-flash", name: "DeepSeek V4 Flash", context: 131072, maxTokens: 16384, input: ["text"], reasoning: false, reasoningLevels: [], capabilities: ["text"] },
  ...
  { id: "deepseek-v4-pro-0813", name: "DeepSeek V4 Pro 0813", context: 131072, maxTokens: 16384, input: ["text"], reasoning: true, reasoningLevels: ["low", "medium", "high"], capabilities: ["text", "reasoning"] },
];
const modelCatalog = {
