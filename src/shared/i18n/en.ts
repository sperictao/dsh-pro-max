...
export const en = {
  ...
  "Latest on npm": "Latest on npm",
  "Verified stack": "Verified stack",
  "A newer dsh is available (v{{latest}}). The bundled authorization plugins are verified against the stack above; upgrade via npm if you do not rely on remote access.": "A newer dsh is available (v{{latest}}). The bundled authorization plugins are verified against the stack above; upgrade via npm if you do not rely on remote access.",
