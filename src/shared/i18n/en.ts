...
export const en = {
  ...
  "The verified stack is {{version}} — the dsh version this app's bundled authorization plugins are tested against. Versions marked unverified work for local access but remote authorization is untested.": "The verified stack is {{version}} — the dsh version this app's bundled authorization plugins are tested against. Versions marked unverified work for local access but remote authorization is untested.",
