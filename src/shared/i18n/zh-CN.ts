...
export const zhCN: Record<I18nKey, string> = {
  ...
  "Installed": "已安装",
  "Not installed": "未安装",
  "Latest on npm": "npm 最新版",
  "Verified stack": "验证过的兼容栈",
  "A newer dsh is available (v{{latest}}). The bundled authorization plugins are verified against the stack above; upgrade via npm if you do not rely on remote access.": "dsh 有新版本（v{{latest}}）。内置授权插件仅在上面的兼容栈上验证过；不依赖远程访问时可自行用 npm 升级。",
